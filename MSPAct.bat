@echo off&color 70&mode con: cols=92 lines=30&title  Microsoft Product Activator (CMD Version) (v1.0) by #dp23>nul
...
if %ecode% EQU 0xC004C008 (goto ExportIID)
if %ecode% EQU 0xC004C020 (goto ExportIID)
goto Notification
:ExportIID
echo:
